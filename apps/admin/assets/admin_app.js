...
function renderLlmQualityFrameworkDashboard(summary) {
  ...
  renderLlmResult('llm-quality-scorecard', {
    ...
    categoryImprovementRate: Number.isFinite(Number(quality.categoryImprovementRate)) ? Number(quality.categoryImprovementRate) : 0,
    categoryRegressionRate: Number.isFinite(Number(quality.categoryRegressionRate)) ? Number(quality.categoryRegressionRate) : 0,
    improvedDimensions: Array.isArray(quality.improvedDimensions) ? quality.improvedDimensions : [],
    regressedDimensions: Array.isArray(quality.regressedDimensions) ? quality.regressedDimensions : [],
    unmetCategories: Array.isArray(quality.unmetCategories) ? quality.unmetCategories : [],
    warningCategoryCount: Number.isFinite(Number(quality.warningCategoryCount)) ? Number(quality.warningCategoryCount) : 0,
    failCategoryCount: Number.isFinite(Number(quality.failCategoryCount)) ? Number(quality.failCategoryCount) : 0,
