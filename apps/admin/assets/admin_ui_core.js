...
function setTraceToUrl(url, traceId) {
  ...
  const DEFAULT_NAV_PANE_POLICY = Object.freeze({
    operator: Object.freeze(['home', 'alerts', 'composer', 'monitor', 'errors', 'read-model', 'city-pack', 'emergency-layer', 'llm', 'audit', 'settings', 'ops-system-health', 'ops-feature-catalog', 'maintenance']),
    admin: Object.freeze(['home', 'alerts', 'composer', 'monitor', 'errors', 'read-model', 'vendors', 'emergency-layer', 'city-pack', 'audit', 'settings', 'llm', 'maintenance', 'developer-map', 'developer-manual-redac', 'developer-manual-user', 'ops-system-health', 'ops-feature-catalog']),
    developer: Object.freeze(['home', 'alerts', 'composer', 'monitor', 'errors', 'read-model', 'vendors', 'emergency-layer', 'city-pack', 'audit', 'settings', 'llm', 'maintenance', 'developer-map', 'developer-manual-redac', 'developer-manual-user', 'ops-system-health', 'ops-feature-catalog'])
  });
