...
| I) preflight/test/start | `npm run preflight` / `npm test` / `npm run start` + `curl -i http://localhost:8091/` | all PASS | preflight ok / tests pass / 200 ok (PORT=8091) | ターミナルログ | PASS |
