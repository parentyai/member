...
| 5 | `src/usecases/admin/getUserOperationalSummary.js` | 302 | listAllEvents | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 6 | `src/usecases/admin/getUserOperationalSummary.js` | 306 | listAllEvents | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 7 | `src/usecases/admin/getUserOperationalSummary.js` | 314 | listAllNotificationDeliveries | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 8 | `src/usecases/admin/getUserOperationalSummary.js` | 330 | listAllNotificationDeliveries | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 9 | `src/usecases/admin/getUserOperationalSummary.js` | 339 | listAllChecklists | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 10 | `src/usecases/admin/getUserOperationalSummary.js` | 347 | listAllUserChecklists | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
