...
| --- | --- | --- | --- | --- | --- |
| 1 | `src/repos/firestore/analyticsReadRepo.js` | 77 | listAllEvents | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 2 | `src/repos/firestore/analyticsReadRepo.js` | 113 | listAllUsers | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 3 | `src/repos/firestore/analyticsReadRepo.js` | 134 | listAllChecklists | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 4 | `src/repos/firestore/analyticsReadRepo.js` | 159 | listAllUserChecklists | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 5 | `src/repos/firestore/analyticsReadRepo.js` | 206 | listAllNotificationDeliveries | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
| 6 | `src/repos/firestore/analyticsReadRepo.js` | 266 | listAllNotifications | 1000 | limit上限固定 + snapshot/read-model優先 + where条件明示 |
