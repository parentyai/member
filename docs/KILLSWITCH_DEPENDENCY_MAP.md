...
| `src/routes/webhookLine.js` | 5600 | `const customKillSwitchFn = options && typeof options.getKillSwitchFn === 'function'` |
| `src/routes/webhookLine.js` | 5601 | `? options.getKillSwitchFn` |
