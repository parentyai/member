...
| `src/routes/admin/osDashboardKpi.js` | 210 | `systemFlagsRepo.getKillSwitch()` |
...
| `src/routes/webhookLine.js` | 1386 | `const customKillSwitchFn = options && typeof options.getKillSwitchFn === 'function'` |
| `src/routes/webhookLine.js` | 1387 | `? options.getKillSwitchFn` |
