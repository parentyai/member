...
| `src/routes/webhookLine.js` | 2913 | `const customKillSwitchFn = options && typeof options.getKillSwitchFn === 'function'` |
| `src/routes/webhookLine.js` | 2914 | `? options.getKillSwitchFn` |
