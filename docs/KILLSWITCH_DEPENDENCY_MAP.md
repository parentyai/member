...
| `src/routes/webhookLine.js` | 1425 | `const customKillSwitchFn = options && typeof options.getKillSwitchFn === 'function'` |
| `src/routes/webhookLine.js` | 1426 | `? options.getKillSwitchFn` |
