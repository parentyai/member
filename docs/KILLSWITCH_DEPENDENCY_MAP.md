...
| `src/routes/webhookLine.js` | 4449 | `const customKillSwitchFn = options && typeof options.getKillSwitchFn === 'function'` |
| `src/routes/webhookLine.js` | 4450 | `? options.getKillSwitchFn` |
