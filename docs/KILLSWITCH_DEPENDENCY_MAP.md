...
| `src/routes/webhookLine.js` | 2271 | `const customKillSwitchFn = options && typeof options.getKillSwitchFn === 'function'` |
| `src/routes/webhookLine.js` | 2272 | `? options.getKillSwitchFn` |
