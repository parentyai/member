...
| `src/routes/webhookLine.js` | 4466 | `const customKillSwitchFn = options && typeof options.getKillSwitchFn === 'function'` |
| `src/routes/webhookLine.js` | 4467 | `? options.getKillSwitchFn` |
