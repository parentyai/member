...
| `src/routes/webhookLine.js` | 3295 | `const customKillSwitchFn = options && typeof options.getKillSwitchFn === 'function'` |
| `src/routes/webhookLine.js` | 3296 | `? options.getKillSwitchFn` |
