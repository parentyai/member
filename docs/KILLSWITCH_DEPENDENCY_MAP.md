...
| `src/routes/webhookLine.js` | 2892 | `const customKillSwitchFn = options && typeof options.getKillSwitchFn === 'function'` |
| `src/routes/webhookLine.js` | 2893 | `? options.getKillSwitchFn` |
