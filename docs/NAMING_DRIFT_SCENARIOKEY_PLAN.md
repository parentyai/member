...
| field | count | paths |
| --- | --- | --- |
| scenario (legacy) | 4 | `src/repos/firestore/checklistsRepo.js`<br>`src/repos/firestore/phase2ReportsRepo.js`<br>`src/repos/firestore/scenarioReportsRepo.js`<br>`src/usecases/phase2/runAutomation.js` |
