...
- admin quality patrol query: `success/completed`, `error/not_found`, `error/error`
  ...
  - nested `desktopPatrolSummary.promotionReview`: latest review artifact kind / branch / worktree ref / patch draft ref / code edit task ref / code apply draft ref / code review packet ref / updatedAt
