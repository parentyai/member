...
- admin quality patrol query: `success/completed`, `error/not_found`, `error/error`
  ...
  - nested `desktopPatrolSummary.promotionApproval`: approval stage / status / draft PR ref / worktree ref / patch request ref / code apply task ref / code apply signoff ref / code apply record ref / validationCommandCount / candidateEditCount / operatorInstructionCount / nextCommand / remainingCommandCount / nextAction / updatedAt
