...
- operator surface can copy `nextCommand`, `remainingCommands`, `latestPromptRef.path`, `latestArtifactRef.path`, `validationCommands`, and `operatorInstructions` without adding new server-side write authority
