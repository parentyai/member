...
- `docs/PHASE319_PLAN.md`（Read Path収束 follow-up: user operational summary bounded range化計画）
- `docs/PHASE319_EXECUTION_LOG.md`（Read Path収束 follow-up: user operational summary bounded range化実行ログ）
- `docs/PHASE320_PLAN.md`（Read Path収束 follow-up: user state summary user-targeted + bounded range化計画）
...
- `docs/PHASE323_PLAN.md`（Read Path収束 follow-up: phase5 notifications summary bounded knobs追加計画）
...
- `docs/PHASE326_PLAN.md`（Read Path収束 follow-up: phase4 users summary bounded knobs追加計画）
...
- `docs/PHASE330_PLAN.md`（Read Path収束 follow-up: phase4 notifications summary snapshotMode + snapshot build追加計画）
...
- `docs/PHASE579_PLAN.md`（Dashboard Redesign: 経営・運用判断中枢化計画）
...
- `docs/PHASE587_PLAN.md`（Read Path収束継続: phase4 summary global fallback bounded化計画）
