...
function buildAnswerReadinessContext(params) {
  ...
  const v2Input = Object.assign({}, legacyInput, {
    ...
    requestedCityKey: knowledge.requestedCityKey,
    matchedCityKey: knowledge.matchedCityKey,
    citySpecificitySatisfied: knowledge.citySpecificitySatisfied === true,
    citySpecificityReason: knowledge.citySpecificityReason || null,
    scopeDisclosureRequired: knowledge.scopeDisclosureRequired === true,
