...
const ROOT_CAUSE_TYPE = Object.freeze({
  ...
  specificityResolutionGap: 'specificity_resolution_gap',
  sourceTransformDrop: 'source_transform_drop',
  deepenPlannerReset: 'deepen_planner_reset',
  regionCommandCollision: 'region_command_collision',
...
const ROOT_CAUSE_LABELS = Object.freeze({
  ...
  [ROOT_CAUSE_TYPE.specificityResolutionGap]: 'City-level specificity was not resolved tightly enough for a grounded answer.',
  [ROOT_CAUSE_TYPE.sourceTransformDrop]: 'Source-aware transform lost facts from the prior assistant answer.',
  [ROOT_CAUSE_TYPE.deepenPlannerReset]: 'Deepen handling reset into a shallow template instead of expanding one layer deeper.',
  [ROOT_CAUSE_TYPE.regionCommandCollision]: 'Natural-language city hints collided with region-command handling.',
...
const FIXED_ROOT_CAUSE_BY_METRIC = Object.freeze({
  ...
  transformSourceDropRate: ROOT_CAUSE_TYPE.sourceTransformDrop,
  deepenResetRate: ROOT_CAUSE_TYPE.deepenPlannerReset,
  messageOnlyViolatedRate: ROOT_CAUSE_TYPE.detailBlindGeneration,
  correctionIgnoredRate: ROOT_CAUSE_TYPE.contextOverride,
  mixedDomainCollapseRate: ROOT_CAUSE_TYPE.intentCompression,
  cityOverclaimRate: ROOT_CAUSE_TYPE.specificityResolutionGap,
...
const FIXED_ROOT_CAUSE_BY_CATEGORY = Object.freeze({
  ...
  transform_source_drop: ROOT_CAUSE_TYPE.sourceTransformDrop,
  deepen_reset: ROOT_CAUSE_TYPE.deepenPlannerReset,
  message_only_violated: ROOT_CAUSE_TYPE.detailBlindGeneration,
  correction_ignored: ROOT_CAUSE_TYPE.contextOverride,
  mixed_domain_collapse: ROOT_CAUSE_TYPE.intentCompression,
  city_scope_overclaim: ROOT_CAUSE_TYPE.specificityResolutionGap,
...
const FIXED_ROOT_CAUSE_BY_ISSUE_CODE = Object.freeze({
  ...
  QP_TRANSFORM_SOURCE_DROP: ROOT_CAUSE_TYPE.sourceTransformDrop,
  QP_DEEPEN_RESET: ROOT_CAUSE_TYPE.deepenPlannerReset,
  QP_MESSAGE_ONLY_VIOLATED: ROOT_CAUSE_TYPE.detailBlindGeneration,
  QP_CORRECTION_IGNORED: ROOT_CAUSE_TYPE.contextOverride,
  QP_MIXED_DOMAIN_COLLAPSE: ROOT_CAUSE_TYPE.intentCompression,
  QP_CITY_SCOPE_OVERCLAIM: ROOT_CAUSE_TYPE.specificityResolutionGap,
