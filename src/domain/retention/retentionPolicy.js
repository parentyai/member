...
const RETENTION_POLICY = Object.freeze({
  ...
  'delivery_records': Object.freeze({ kind: 'evidence', retentionDays: 365, deletable: 'NO', recomputable: false }),
  'emergency_bulletins': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  ...
  'journey_reminder_runs': Object.freeze({ kind: 'evidence', retentionDays: 365, deletable: 'NO', recomputable: false }),
  'journey_templates': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  'journey_todo_items': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  'journey_todo_stats': Object.freeze({ kind: 'aggregate', retentionDays: 90, deletable: 'NO', recomputable: false }),
  'link_registry': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  'llm_action_logs': Object.freeze({ kind: 'event', retentionDays: 180, deletable: 'CONDITIONAL', recomputable: true }),
  'llm_bandit_state': Object.freeze({ kind: 'aggregate', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  'llm_contextual_bandit_state': Object.freeze({ kind: 'aggregate', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  ...
  'liff_synthetic_events': Object.freeze({ kind: 'event', retentionDays: 180, deletable: 'CONDITIONAL', recomputable: true }),
  'memory_compliance': Object.freeze({ kind: 'config', retentionDays: 365, deletable: 'CONDITIONAL', recomputable: true }),
  'memory_profile': Object.freeze({ kind: 'config', retentionDays: 365, deletable: 'CONDITIONAL', recomputable: true }),
  'memory_session': Object.freeze({ kind: 'event', retentionDays: 90, deletable: 'CONDITIONAL', recomputable: true }),
  'memory_task': Object.freeze({ kind: 'config', retentionDays: 180, deletable: 'CONDITIONAL', recomputable: true }),
  'municipality_schools': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  ...
  'rich_menu_phase_profiles': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  'rich_menu_rate_buckets': Object.freeze({ kind: 'transient', retentionDays: 30, deletable: 'CONDITIONAL', recomputable: true }),
  'rich_menu_rollout_runs': Object.freeze({ kind: 'evidence', retentionDays: 365, deletable: 'NO', recomputable: false }),
  'rich_menu_templates': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  'send_retry_queue': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  'school_calendar_links': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  ...
  'step_rule_change_logs': Object.freeze({ kind: 'evidence', retentionDays: 365, deletable: 'NO', recomputable: false }),
  ...
  'task_events': Object.freeze({ kind: 'evidence', retentionDays: 365, deletable: 'NO', recomputable: false }),
  ...
  'user_journey_profiles': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  'user_journey_schedules': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
