...
const RETENTION_POLICY = Object.freeze({
  ...
  'journey_reminder_runs': Object.freeze({ kind: 'event', retentionDays: 180, deletable: 'CONDITIONAL', recomputable: true }),
  'journey_todo_items': Object.freeze({ kind: 'config', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
  'journey_todo_stats': Object.freeze({ kind: 'aggregate', retentionDays: 'INDEFINITE', deletable: 'NO', recomputable: false }),
