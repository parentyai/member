...
// LEGACY_ALIAS: src/repos/firestore/phase18StatsRepo.js -> src/repos/firestore/ctaStatsRepo.js
// LEGACY_STATUS: DEPRECATED
'use strict';

// DEPRECATED:
// - Legacy alias kept for backward compatibility.
// - Canonical implementation: ctaStatsRepo.
module.exports = require('./ctaStatsRepo');
