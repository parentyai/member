...
// LEGACY_ALIAS: src/repos/firestore/phase22KpiSnapshotsReadRepo.js -> src/repos/firestore/kpiSnapshotsReadRepo.js
// LEGACY_STATUS: DEPRECATED
'use strict';

// DEPRECATED:
// - Legacy alias kept for backward compatibility.
// - Canonical implementation: kpiSnapshotsReadRepo.
module.exports = require('./kpiSnapshotsReadRepo');
