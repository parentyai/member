...
const { submitOpsDecision } = require('../usecases/phase25/submitOpsDecision');
...
async function handleSubmitOpsDecision(req, res, body) {
  ...
  try {
    ...
    const result = await submitOpsDecision(enriched);
