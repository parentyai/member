...
function composeItem(cityPack, reason) {
  return {
    ...
    regionKey: cityPack.regionKey || (cityPack.metadata && cityPack.metadata.regionKey) || null,
    regionCity: cityPack.regionCity || (cityPack.metadata && cityPack.metadata.regionCity) || null,
    regionState: cityPack.regionState || (cityPack.metadata && cityPack.metadata.regionState) || null,
    sourceRefs: Array.isArray(cityPack.sourceRefs) ? cityPack.sourceRefs.slice(0, 8) : [],
