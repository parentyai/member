...
test('phase632: package scripts expose firestore index check/plan/apply commands', () => {
  ...
  assert.strictEqual(pkg.scripts['firestore-indexes:apply'], 'node scripts/check_firestore_indexes.js --apply');
});
