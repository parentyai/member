...
test('phase705: consistency status keeps scenario alias at zero and scenarioKey drift at or below 32', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 32, `scenarioKey drift should be <= 32, got ${current.scenarioKey}`);
});
