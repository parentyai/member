...
const REQUIRED_RESOLVED_BATCH3 = Object.freeze([
  ...
  'src/routes/admin/taskRulesConfig.js',
  'src/usecases/admin/getNotificationOperationalSummary.js',
  'src/usecases/admin/getNotificationReadModel.js'
]);

test('phase706: resolved scenarioKey lock includes batch3 paths and current drift excludes them', () => {
  ...
  REQUIRED_RESOLVED_BATCH3.forEach((file) => {
