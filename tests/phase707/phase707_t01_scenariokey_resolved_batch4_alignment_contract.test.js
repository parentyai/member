...
const REQUIRED_RESOLVED_BATCH4 = Object.freeze([
  'src/usecases/admin/getUserOperationalSummary.js',
  'src/usecases/phase5/getUserStateSummary.js'
]);

test('phase707: resolved scenarioKey lock includes batch4 paths and current drift excludes them', () => {
  ...
  REQUIRED_RESOLVED_BATCH4.forEach((file) => {
