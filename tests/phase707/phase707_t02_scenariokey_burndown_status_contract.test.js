...
test('phase707: consistency status keeps scenario alias at zero and scenarioKey drift at or below 23', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 23, `scenarioKey drift should be <= 23, got ${current.scenarioKey}`);
});
