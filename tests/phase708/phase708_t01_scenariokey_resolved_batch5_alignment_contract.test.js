...
const REQUIRED_RESOLVED_BATCH5 = Object.freeze([
  'src/domain/journey/lineCommandParsers.js',
  'src/domain/normalizers/scenarioKeyNormalizer.js'
]);

test('phase708: resolved scenarioKey lock includes batch5 paths and current drift excludes them', () => {
  ...
  REQUIRED_RESOLVED_BATCH5.forEach((file) => {
