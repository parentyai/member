...
test('phase708: consistency status keeps scenario alias at zero and scenarioKey drift at or below 21', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 21, `scenarioKey drift should be <= 21, got ${current.scenarioKey}`);
});
