...
const REQUIRED_RESOLVED_BATCH6 = Object.freeze([
  'src/usecases/notifications/createNotification.js',
  'src/usecases/notifications/createNotificationPhase1.js'
]);

test('phase709: resolved scenarioKey lock includes batch6 paths and current drift excludes them', () => {
  ...
  REQUIRED_RESOLVED_BATCH6.forEach((file) => {
