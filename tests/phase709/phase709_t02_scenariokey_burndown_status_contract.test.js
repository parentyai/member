...
test('phase709: consistency status keeps scenario alias at zero and scenarioKey drift at or below 19', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 19, `scenarioKey drift should be <= 19, got ${current.scenarioKey}`);
});
