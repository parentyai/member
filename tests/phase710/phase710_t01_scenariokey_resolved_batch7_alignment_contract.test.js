...
const REQUIRED_RESOLVED_BATCH7 = Object.freeze([
  'src/repos/firestore/journeyTodoItemsRepo.js',
  'src/repos/firestore/tasksRepo.js'
]);

test('phase710: resolved scenarioKey lock includes batch7 paths and current drift excludes them', () => {
  ...
  REQUIRED_RESOLVED_BATCH7.forEach((file) => {
