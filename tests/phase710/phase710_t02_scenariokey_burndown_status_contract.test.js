...
test('phase710: consistency status keeps scenario alias at zero and scenarioKey drift at or below 17', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 17, `scenarioKey drift should be <= 17, got ${current.scenarioKey}`);
});
