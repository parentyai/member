...
const REQUIRED_RESOLVED_BATCH8 = Object.freeze([
  'src/repos/firestore/notificationsRepo.js',
  'src/repos/firestore/stepRulesRepo.js'
]);

test('phase711: resolved scenarioKey lock includes batch8 paths and current drift excludes them', () => {
  ...
  REQUIRED_RESOLVED_BATCH8.forEach((file) => {
