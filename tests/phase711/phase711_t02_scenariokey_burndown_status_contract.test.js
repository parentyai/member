...
test('phase711: consistency status keeps scenario alias at zero and scenarioKey drift at or below 15', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 15, `scenarioKey drift should be <= 15, got ${current.scenarioKey}`);
});
