...
const REQUIRED_RESOLVED_BATCH9 = Object.freeze([
  'src/repos/firestore/userJourneyProfilesRepo.js',
  'src/repos/firestore/usersPhase1Repo.js'
]);

test('phase712: resolved scenarioKey lock includes batch9 paths and current drift excludes them', () => {
  ...
  REQUIRED_RESOLVED_BATCH9.forEach((file) => {
