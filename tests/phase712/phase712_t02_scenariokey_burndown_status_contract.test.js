...
test('phase712: consistency status keeps scenario alias at zero and scenarioKey drift at or below 13', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 13, `scenarioKey drift should be <= 13, got ${current.scenarioKey}`);
});
