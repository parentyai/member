...
test('phase713: consistency status keeps scenario alias at zero and scenarioKey drift at or below 11', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 11, `scenarioKey drift should be <= 11, got ${current.scenarioKey}`);
});
