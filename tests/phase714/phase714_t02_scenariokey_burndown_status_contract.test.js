...
test('phase714: consistency status keeps scenario alias at zero and scenarioKey drift at or below 9', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 9, `scenarioKey drift should be <= 9, got ${current.scenarioKey}`);
});
