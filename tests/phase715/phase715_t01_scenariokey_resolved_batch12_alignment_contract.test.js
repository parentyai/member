...
const REQUIRED_RESOLVED_BATCH12 = Object.freeze([
  'src/usecases/journey/runJourneyParamDryRun.js',
  'src/usecases/phase33/executeOpsNextAction.js'
]);

test('phase715: resolved scenarioKey lock includes batch12 paths and current drift excludes them', () => {
  ...
  REQUIRED_RESOLVED_BATCH12.forEach((file) => {
