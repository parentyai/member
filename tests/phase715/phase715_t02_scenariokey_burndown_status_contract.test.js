...
test('phase715: consistency status keeps scenario alias at zero and scenarioKey drift at or below 7', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 7, `scenarioKey drift should be <= 7, got ${current.scenarioKey}`);
});
