...
test('phase716: consistency status keeps scenario alias at zero and scenarioKey drift at or below 5', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 5, `scenarioKey drift should be <= 5, got ${current.scenarioKey}`);
});
