...
test('phase717: consistency status keeps scenario alias at zero and scenarioKey drift at or below 3', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 3, `scenarioKey drift should be <= 3, got ${current.scenarioKey}`);
});
