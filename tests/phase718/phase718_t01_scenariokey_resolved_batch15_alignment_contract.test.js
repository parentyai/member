...
const REQUIRED_RESOLVED_BATCH15 = Object.freeze([
  'src/usecases/emergency/approveEmergencyBulletin.js',
  'src/usecases/tasks/computeUserTasks.js'
]);

test('phase718: resolved scenarioKey lock includes batch15 paths and current drift excludes them', () => {
  ...
  REQUIRED_RESOLVED_BATCH15.forEach((file) => {
