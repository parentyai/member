...
test('phase718: consistency status keeps scenario alias at zero and scenarioKey drift at or below 1', () => {
  ...
  assert.ok(Number(current.scenarioKey) <= 1, `scenarioKey drift should be <= 1, got ${current.scenarioKey}`);
});
