...
test('phase718: deploy-webhook workflow enforces strict LLM runtime env/secret wiring and gate', () => {
  ...
  assert.match(workflow, /--required-env "SERVICE_MODE,LLM_FEATURE_FLAG,OPENAI_MODEL,ENABLE_PAID_ORCHESTRATOR_V2"/, 'deploy-webhook runtime contract must require orchestrator env');
