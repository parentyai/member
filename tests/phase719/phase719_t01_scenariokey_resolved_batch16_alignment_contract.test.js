...
const REQUIRED_RESOLVED_BATCH16 = Object.freeze([
  'src/repos/firestore/analyticsReadRepo.js'
]);

test('phase719: resolved scenarioKey lock includes batch16 path and current drift excludes it', () => {
  ...
  REQUIRED_RESOLVED_BATCH16.forEach((file) => {
