...
const CONCIERGE_RUNTIME_SIGNAL_RULES = Object.freeze({
  ...
  citySpecificityResolvedRate: { threshold: 0.9, direction: 'min', label: 'City specificity resolved rate' },
  cityOverclaimRate: { threshold: 0, direction: 'max', label: 'City overclaim rate' },
  transformSourceCarryRate: { threshold: 0.9, direction: 'min', label: 'Transform-source carry rate' },
  depthResetRate: { threshold: 0.05, direction: 'max', label: 'Depth reset rate' },
