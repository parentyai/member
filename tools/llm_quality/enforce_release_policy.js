...
function main(argv) {
  ...
  const runtimeSignals = runtimeSignalRaw
    ? {
      ...
      oneTurnUtilityRate: runtimeSignalRaw.oneTurnUtilityRate,
      procedureScaffoldCoverageRate: runtimeSignalRaw.procedureScaffoldCoverageRate,
      relevanceFitRate: runtimeSignalRaw.relevanceFitRate,
      offTargetAnswerRate: runtimeSignalRaw.offTargetAnswerRate,
      decisionReadinessRate: runtimeSignalRaw.decisionReadinessRate,
      dependencyExplicitnessRate: runtimeSignalRaw.dependencyExplicitnessRate,
      fakeSpecificityRate: runtimeSignalRaw.fakeSpecificityRate,
      userEffortShiftRate: runtimeSignalRaw.userEffortShiftRate,
      procedureKnowledgeUseRate: runtimeSignalRaw.procedureKnowledgeUseRate,
      transformBadFactCarryRate: runtimeSignalRaw.transformBadFactCarryRate,
